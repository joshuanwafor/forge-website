...
const variants: Record<Variant, string> = {
  primary:
    "bg-ember-400 text-ink-950 shadow-[0_8px_30px_-8px_rgb(250_204_21_/_0.5)] hover:bg-ember-300 hover:shadow-[0_12px_40px_-8px_rgb(250_204_21_/_0.65)] active:bg-ember-500",
  secondary:
